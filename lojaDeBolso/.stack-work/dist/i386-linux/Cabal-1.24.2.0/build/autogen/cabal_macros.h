...
/* package lojaDeBolso-0.0.0 */
#define VERSION_lojaDeBolso "0.0.0"
#define MIN_VERSION_lojaDeBolso(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
...
#define CURRENT_COMPONENT_ID "lojaDeBolso-0.0.0"

#define CURRENT_PACKAGE_KEY "lojaDeBolso-0.0.0"
